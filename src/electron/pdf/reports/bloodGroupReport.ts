...
export function addBloodGroupData(data: any, doc: PDFKit.PDFDocument, topMargin: number, normalRanges: NormalRange[], patientDateOfBirth: Date, patientGender: string) {
    const config: PDFConfig = {
        ...
        textEntries: [
            { label: "Blood Group", x: 0, y: topMargin, fontSize: 15, weight: "bold", options: { align: "center", width: 595 } },
    ...
    const tests: TestEntry[] = [
        { name: "Blood group", value: data.bloodGroup, testFieldId: -1, unit: "" },
    ];
